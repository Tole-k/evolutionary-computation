...
) -> tuple[list[int], list[float], list[int], list[float], list[int]]: ...
def assignment_7(dataset: str, removal_rate: float) -> list[tuple[str, tuple[list[int], list[float], list[int]]]]: ...
def similarity_tests(dataset: str, measure: str) -> tuple[list[tuple[float, tuple[int, int, float]]], tuple[float, float, float]]: ...
