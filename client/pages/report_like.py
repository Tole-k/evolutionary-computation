...
from pages.greedy import CONCLUSIONS as conclusions
from pages.greedy import ALGORITHMS as algorithms
...
def load_solution(state) -> tuple[pd.DataFrame, dict[str, float], dict[str, list[int]]]:
