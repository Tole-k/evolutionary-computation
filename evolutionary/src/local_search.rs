...
use crate::local_search_base::{local_search, local_search_full_desc};
...
pub fn ls_greedy_edges_random_full(
    data: &Vec<DataPoint>,
    starting_point_index: usize,
    distance_matrix: &Array2<f64>,
) -> Vec<Vec<usize>> {
    let initial_solution = generate_random_solution(data, starting_point_index, distance_matrix);
    local_search_full_desc(data, initial_solution, distance_matrix, true, true)
}

pub fn ls_greedy_edges_greedy_full(
    data: &Vec<DataPoint>,
    starting_point_index: usize,
    distance_matrix: &Array2<f64>,
) -> Vec<Vec<usize>> {
...
pub fn ls_greedy_nodes_random_full(
    data: &Vec<DataPoint>,
    starting_point_index: usize,
    distance_matrix: &Array2<f64>,
) -> Vec<Vec<usize>> {
    let initial_solution = generate_random_solution(data, starting_point_index, distance_matrix);
    local_search_full_desc(data, initial_solution, distance_matrix, true, false)
}

pub fn ls_greedy_nodes_greedy_full(
    data: &Vec<DataPoint>,
    starting_point_index: usize,
    distance_matrix: &Array2<f64>,
) -> Vec<Vec<usize>> {
...
pub fn ls_steepest_edges_random_full(
    data: &Vec<DataPoint>,
    starting_point_index: usize,
    distance_matrix: &Array2<f64>,
) -> Vec<Vec<usize>> {
    let initial_solution = generate_random_solution(data, starting_point_index, distance_matrix);
    local_search_full_desc(data, initial_solution, distance_matrix, false, true)
}

pub fn ls_steepest_edges_greedy_full(
    data: &Vec<DataPoint>,
    starting_point_index: usize,
    distance_matrix: &Array2<f64>,
) -> Vec<Vec<usize>> {
...
pub fn ls_steepest_nodes_random_full(
    data: &Vec<DataPoint>,
    starting_point_index: usize,
    distance_matrix: &Array2<f64>,
) -> Vec<Vec<usize>> {
    let initial_solution = generate_random_solution(data, starting_point_index, distance_matrix);
    local_search_full_desc(data, initial_solution, distance_matrix, false, false)
}

pub fn ls_steepest_nodes_greedy_full(
    data: &Vec<DataPoint>,
    starting_point_index: usize,
    distance_matrix: &Array2<f64>,
) -> Vec<Vec<usize>> {
